                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#0672CB; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Você esqueceu sua senha?</h1>
                                            <span
                                        ...
                                        <label style="display:inline-block; vertical-align:middle; font-family:'Rubik',sans-serif;color:#455056; font-size:15px;line-height:24px; margin:0;">Código de Redefinição: </label>
                                            <label href="javascript:void(0);"
                                                style="background:#0672CB;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">${code}</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height:40px;">&nbsp;</td>
...
exports.html = html;
//# sourceMappingURL=htmlSendForgot.js.map